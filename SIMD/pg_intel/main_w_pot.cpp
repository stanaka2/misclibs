// g++ -DAVX512 -std=c++17 -O3 -mavx2 -mfma -mavx512f -mavx512dq -mavx512vl main_w_pot.cpp -o test_avx512_w_pot
// g++ -DAVX512_PD -std=c++17 -O3 -mavx2 -mfma -mavx512f -mavx512dq -mavx512vl main_w_pot.cpp -o test_avx512_w_pot_pd
                        ...
                        double eps2_pp, double eps_pm)
{
  ...
  calc_grav_simd_thread_with_pot(iptcl, ppforce, ni, xj, mj, nj, eps2_pp, eps_pm);
}
